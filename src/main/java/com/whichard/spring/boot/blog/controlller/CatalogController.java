...
import com.whichard.spring.boot.blog.service.CatalogService;
import com.whichard.spring.boot.blog.util.ConstraintViolationExceptionHandler;
import com.whichard.spring.boot.blog.vo.CatalogVO;
...
public class CatalogController {
    ...
    public ResponseEntity<Response> create(@RequestBody CatalogVO catalogVO) {
        ...
        return ResponseEntity.ok().body(new Response(true, "创建/修改分类成功", null));
    }
