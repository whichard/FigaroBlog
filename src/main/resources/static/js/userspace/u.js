...
$(function () {
    ...
    //处理删除博客事件
    $(".blog-list-container").on("click", ".blog-delete-blog", function () {
        // 获取 CSRF Token
    ...
    // 获取编辑分类的页面
    $(".blog-content").on("click", ".blog-add-catalog", function () {
        $.ajax({
            url: '/catalogs/edit',
            type: 'GET',
            success: function (data) {
    ...
    // 获取编辑某个分类的页面
    $(".blog-content").on("click", ".blog-edit-catalog", function () {
    ...
    $(".blog-content").on("click", ".blog-delete-catalog", function () {
    ...
    $("#submitDelete").click(function () {
        ...
        $.ajax({
            url: '/catalogs/' + catalogId + '?username=' + username,
            type: 'DELETE',
            beforeSend: function (request) {
                request.setRequestHeader(csrfHeader, csrfToken); // 添加  CSRF Token 
            },
    ...
    // 根据分类查询
    $(".blog-content").on("click", ".blog-query-by-catalog", function () {
        catalogId = $(this).attr('catalogId');
        getBlogsByName(0, _pageSize);
    });
